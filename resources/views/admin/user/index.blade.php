              ...
              <div class="table-responsive theme-scrollbar mt-3">
                <table class="table display table-bordernone" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $i + 1 }}</td>
                      <td><h6 class="mb-0">{{ $u->nama }}</h6></td>
                      <td>{{ $u->email }}</td>
                      <td>
                        @php $badge = ['admin'=>'danger','petugas'=>'warning','anggota'=>'success'][$u->role] ?? 'secondary'; @endphp
                        <span class="badge bg-light-{{ $badge }} text-{{ $badge }}">{{ ucfirst($u->role) }}</span>
                      </td>
