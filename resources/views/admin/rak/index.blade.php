  ...
  <div class="page-body">
    <div class="container-fluid">
      <div class="page-title">
        <div class="row">
          <div class="col-sm-6 col-12"><h2>Kelola Rak</h2></div>
            ...
            <div class="card-header card-no-border pb-0">
              <div class="header-top">
                ...
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambah">
                  <i class="iconly-Plus icli me-1"></i> Tambah Rak
                </button>
              </div>
            </div>
              ...
              <div class="table-responsive theme-scrollbar mt-3">
                <table class="table display table-bordernone" style="width:100%">
                  ...
                  <tbody>
                    ...
                    @empty
                    <tr><td colspan="5" class="text-center text-muted py-4">Belum ada rak</td></tr>
                    @endforelse
                  </tbody>
                </table>
              </div>
    ...
    <div class="modal-content">
      <form action="{{ route('admin.rak.store') }}" method="POST">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label fw-semibold">Nama Rak <span class="text-danger">*</span></label>
            <input type="text" name="nama_rak" class="form-control" placeholder="Contoh: Rak A1" required>
          </div>
          <div class="mb-3">
            <label class="form-label fw-semibold">Lokasi</label>
            <input type="text" name="lokasi" class="form-control" placeholder="Contoh: Lantai 1, Bagian Kiri">
          </div>
        </div>
    ...
    <div class="modal-content">
      <form id="formEdit" method="POST">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label fw-semibold">Nama Rak <span class="text-danger">*</span></label>
            <input type="text" name="nama_rak" id="editNama" class="form-control" required>
          </div>
          <div class="mb-3">
            <label class="form-label fw-semibold">Lokasi</label>
    ...
    <div class="modal-content">
      <form id="formHapus" method="POST">
        ...
        <div class="modal-header border-0 pb-0">
          <h5 class="modal-title text-danger">Hapus Rak</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body pt-2">
          <p class="mb-0">Yakin hapus rak <strong id="hapusNama"></strong>?</p>
        </div>
...
<script>
  document.querySelectorAll('.btn-edit').forEach(btn => {
    btn.addEventListener('click', function() {
      document.getElementById('formEdit').action = `/admin/rak/${this.dataset.id}`;
  ...
  document.querySelectorAll('.btn-hapus').forEach(btn => {
    btn.addEventListener('click', function() {
      document.getElementById('formHapus').action = `/admin/rak/${this.dataset.id}`;
