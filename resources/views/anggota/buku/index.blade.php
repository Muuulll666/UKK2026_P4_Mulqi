  ...
  <div class="page-body">
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-6">
              <form method="GET" action="{{ route('anggota.buku.index') }}">
                <div class="input-group">
                  ...
                  @if($search)
                    <a href="{{ route('anggota.buku.index') }}" class="btn btn-light">Reset</a>
                  @endif
                </div>
              </form>
            </div>
      ...
      <div class="mt-4 d-flex justify-content-center">
        {{ $buku->appends(['search' => $search])->links() }}
      </div>
    ...
    <div class="modal-content">
      <form action="{{ route('anggota.pinjam.store') }}" method="POST" id="formPinjam">
        ...
        <div class="modal-body">
          <p class="text-muted small mb-3">Kamu akan meminjam buku berikut (maks. 3 buku, durasi 7 hari):</p>
          <ul class="list-group mb-3" id="listBukuDipilih"></ul>
          <div class="alert alert-info small mb-0 py-2">
            <iconify-icon icon="solar:info-circle-bold" class="me-1"></iconify-icon>
            Peminjaman perlu disetujui petugas terlebih dahulu.
          </div>
        </div>
