...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendors/iconly/bulk.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendors/iconly/two-tone.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendors/flag-icon/flag-icon.min.css') }}"/>
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendors/scrollbar/simplebar.css') }}"/>
            ...
            <div class="page-main-header col">
                ...
                <div class="nav-right">
                    <ul class="header-right">
                        <!-- <li class="custom-dropdown">
                            <div class="translate_wrapper">
                                ...
                                <ul class="custom-menu profile-menu language-menu py-0 more_lang">
                                    <li class="d-block"><a class="lang" href="#" data-value="English"><i class="flag-icon flag-icon-us"></i><div class="lang-txt">English</div></a></li>
                                    <li class="d-block"><a class="lang" href="#" data-value="fr"><i class="flag-icon flag-icon-fr"></i><div class="lang-txt">Français</div></a></li>
                        ...
                        <li class="custom-dropdown">
                            <a href="javascript:void(0)">
                                <svg><use href="{{ asset('assets/svg/iconly-sprite.svg#cart-icon') }}"></use></svg>
                            </a>
                            ...
                            <div class="custom-menu cart-dropdown py-0 overflow-hidden">
                                ...
                                <ul class="pb-0">
                                    <li>
                                        <div class="d-flex">
                                            <img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('assets/images/dashboard-2/1.png') }}" alt=""/>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('assets/images/dashboard-2/2.png') }}" alt=""/>
                                            <div class="flex-grow-1">
                                    ...
                                    <li class="text-center">
                                        <a class="d-block mb-3 view-cart f-w-700 text-primary" href="#">Go to your cart</a>
                                        <a class="btn btn-primary view-checkout text-white" href="#">Checkout</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="custom-menu notification-dropdown py-0 overflow-hidden">
                                ...
                                <ul class="activity-timeline">
                                    <li class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-600 font-primary">30-04-2024<span>Today</span>
                                                <span class="circle-dot-primary float-end">
                                                    <svg class="circle-color"><use href="{{ asset('assets/svg/iconly-sprite.svg#circle') }}"></use></svg>
                                                </span>
                                            </h6>
                                            <h5>Alice Goodwin</h5>
                                    ...
                                    <li class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-600 font-secondary">28-06-2024<span>1 hour ago</span>
                                    ...
                                    <li class="d-flex align-items-start">
                                        <div class="activity-dot-primary"></div>
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-600 font-primary">04-08-2024<span>Today</span>
                                    ...
                                    <li class="d-flex align-items-start">
                                        <div class="activity-dot-secondary"></div>
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-600 font-secondary">12-11-2024<span>Yesterday</span>
                                                <span class="float-end circle-dot-secondary">
                                                    <svg class="circle-color"><use href="{{ asset('assets/svg/iconly-sprite.svg#circle') }}"></use></svg>
                                                </span>
                                            </h6>
                        ...
                        <li>
                            <a class="full-screen" href="javascript:void(0)">
                                <svg><use href="{{ asset('assets/svg/iconly-sprite.svg#scanfull') }}"></use></svg>
                            </a>
                        </li>
                        <li class="custom-dropdown">
                            <a href="javascript:void(0)">
                                <svg><use href="{{ asset('assets/svg/iconly-sprite.svg#bookmark') }}"></use></svg>
                            </a>
                                ...
                                <ul>
                                        ...
                                        <form class="mb-0">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text">
                                                    <svg class="svg-color"><use href="{{ asset('assets/svg/iconly-sprite.svg#Search') }}"></use></svg>
                                                </span>
                                            </div>
                                        </form>
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2 btn-activity-primary">
                                            <a href="{{ route('admin.dashboard') }}">
                                                <svg class="svg-color"><use href="{{ asset('assets/svg/iconly-sprite.svg#cube') }}"></use></svg>
                                            </a>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center w-100">
                                            <a href="{{ route('admin.dashboard') }}">Dashboard</a>
                                            <svg class="svg-color icon-star"><use href="{{ asset('assets/svg/iconly-sprite.svg#star') }}"></use></svg>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="profile-nav custom-dropdown">
                            ...
                            <div class="custom-menu overflow-hidden">
                                <ul class="profile-body">
                                    <li class="d-flex">
                                        <svg class="svg-color"><use href="{{ asset('assets/svg/iconly-sprite.svg#Profile') }}"></use></svg>
                                        <a class="ms-2" href="#">Account</a>
                                    </li>
                                    <li class="d-flex">
                                        <svg class="svg-color"><use href="{{ asset('assets/svg/iconly-sprite.svg#Message') }}"></use></svg>
                                        <a class="ms-2" href="#">Inbox</a>
                                    </li>
                                    <li class="d-flex">
                                        <svg class="svg-color"><use href="{{ asset('assets/svg/iconly-sprite.svg#Document') }}"></use></svg>
                                        <a class="ms-2" href="#">Task</a>
                                    </li>
                                    <li class="d-flex">
                                        <svg class="svg-color"><use href="{{ asset('assets/svg/iconly-sprite.svg#Login') }}"></use></svg>
