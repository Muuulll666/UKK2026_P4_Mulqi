...
class BukuController extends Controller
{
    ...
    {
        $buku      = Buku::with(['rak', 'penerbitRelasi', 'pengarangRelasi', 'kategori'])->orderBy('judul')->get();
        $rak       = Rak::orderBy('nama_rak')->get();
        $penerbit  = Penerbit::orderBy('nama')->get();
        $pengarang = Pengarang::orderBy('nama')->get();
        $kategori  = Kategori::orderBy('nama')->get();
        return view('admin.buku.index', compact('buku', 'rak', 'penerbit', 'pengarang', 'kategori'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->only('judul', 'penulis', 'penerbit', 'tahun', 'stok', 'rak_id', 'pengarang', 'penerbit_id', 'pengarang_id', 'kategori_id');
